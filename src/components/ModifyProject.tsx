...
//           },
//           body: JSON.stringify({ title, nameOfCamp,discription,projectURL,img }),
//         }
//       )
//     ).json();
...
//         <Input placeholder=" عنوان المشروع"  onChange={(e) => {
...
//         <Textarea placeholder=" وصف المشروع  " onChange={(e) => {
...
//         <Input placeholder=" وصف المشروع  " onChange={(e) => {
...
//         <Input type="text" placeholder=" رابط الصوره"onChange={(e) => {
